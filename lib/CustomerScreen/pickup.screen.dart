...
class _PickupScreenState extends State<PickupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final driverImageUrl =
        deliveryData2?.data?.deliveryBoy?.image?.toString().isNotEmpty == true
      ...
      onPopInvoked: (didPop) {
        if (!didPop) {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => HomeScreen(forceSocketRefresh: true),
            ),
          );
        }
      },
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${vehicleTypeName}:- ${vehicleTypeNumber}',
                                      style: GoogleFonts.inter(
                                        fontSize: 13.sp,
                            ...
                            if (!_isArrived)
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      _waitingSeconds >= _maxFreeWaitingSeconds
                                      ? Colors.red.shade600
                            ...
                            Text(
                              _waitingSeconds >= _maxFreeWaitingSeconds
                                  ? "Waiting charges are applied now"
                                  : "",
                            ),
                            // SizedBox(height: 15.h),
                            const Divider(),
  ...
  Future<void> _openCustomerLiveTracking() async {
    ...
    final waypoints = widget.dropoff
        .map((d) => '${d['lat']},${d['long']}')
        .join('|');
    final destination =
        '${widget.dropoff.last['lat']},${widget.dropoff.last['long']}';
                    ...
                    child: ElevatedButton(
                      onPressed: _isLoading
                          ...
                          : () async {
                              ...
                              final reason = selectedIndex == reasons.length - 1
  ...
  Future<void> cancelOrderApiStatic(String txId, String reason) async {
    try {
      ...
      Fluttertoast.showToast(
        ...
        backgroundColor: response.code == 0 ? Colors.green : Colors.red,
