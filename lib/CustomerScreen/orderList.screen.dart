...
class _OrderListScreenState extends ConsumerState<OrderListScreen> {
  @override
  Widget build(BuildContext context) {
    final historyProvider = ref.watch(getDeliveryHistoryController);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            SizedBox(height: 15.h),
            historyProvider.when(
              data: (order) {
                // Only show completed deliveries
                final completedDeliveries = order.data!.deliveries!
                    .where((delivery) => delivery.status.toString() == "completed")
                    .toList();
                ...
                return Expanded(
                  child: ListView.builder(
                    padding: EdgeInsets.zero,
                    itemCount: completedDeliveries.length, // ← Fixed: use filtered list
                    itemBuilder: (context, index) {
                      final item = completedDeliveries[index]; // ← Safe access
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Icon(Icons.circle, color: const Color(0xFF086E86), size: 13.sp),
                                        for (int i = 0; i < 7; i++)
                                          Padding(
                                        ...
                                        Icon(Icons.location_on_outlined, color: const Color(0xFFDE4B65), size: 18.sp),
                                      ],
                                    ),
                                    SizedBox(width: 14.w),
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: 4.h),
                                          Text(
                                            item.pickup?.name ?? "Pickup location not available",
                                            style: GoogleFonts.inter(
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w500,
                                              color: Colors.black54,
                                          ...
                                          // Dropoff Locations – SAFE HANDLING
                                          if (item.dropoff != null && item.dropoff!.isNotEmpty)
                                            ...item.dropoff!.map((d) => Padding(
                                              padding: EdgeInsets.only(bottom: 6.h),
                                              child: Text(
                                                d.name ?? "Dropoff location",
                                                style: GoogleFonts.inter(
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.w400,
                              ...
                              Row(
                                children: [
                                  Icon(Icons.check_circle, color: const Color(0xFF086634), size: 18.sp),
                                  SizedBox(width: 5.w),
                                  Text(
                                    "Completed Order",
                                    style: GoogleFonts.inter(
