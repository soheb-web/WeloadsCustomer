...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    empty: json["\u0024__"] == null ? null : Empty.fromJson(json["\u0024__"]),
    isNew: json["\u0024isNew"],
...
class Empty {
  ...
  factory Empty.fromJson(Map<String, dynamic> json) => Empty(
    activePaths: json["activePaths"] == null ? null : ActivePaths.fromJson(json["activePaths"]),
    skipId: json["skipId"],
  );
...
class States {
  ...
  factory States.fromJson(Map<String, dynamic> json) => States(
    require: json["require"] == null ? null : Documents.fromJson(json["require"]),
    statesDefault: json["default"] == null ? null : Default.fromJson(json["default"]),
